          ...
          {activeTab === "subtasks" && (
            <div className="space-y-3">
              ...
              {loadingSubtasks ? (
                ...
                <p className="text-sm text-gray-400 dark:text-gray-500 text-center py-4">No subtasks yet</p>
              ) : (
                <div className="space-y-1">
                  {subtasks.map((subtask) => (
                    <div
                      key={subtask.id}
                      className="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700/50 group"
                    >
                      <button
