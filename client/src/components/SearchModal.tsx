      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200 dark:border-gray-700">
          ...
          <input
            ...
            className="flex-1 text-sm bg-transparent border-none outline-none text-gray-900 dark:text-gray-100 placeholder:text-gray-400"
          />
          <kbd className="hidden sm:inline-flex text-[10px] font-medium text-gray-400 dark:text-gray-500 bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded">
            ESC
          </kbd>
        </div>
        ...
        <div className="max-h-[50vh] overflow-y-auto">
                ...
                <div>
                  ...
                  {results!.boards.map((board) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-2.5 hover:bg-gray-50 dark:hover:bg-gray-700/50 flex items-center gap-3 transition-colors"
                    >
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-400">{board._count.columns} columns</div>
                      </div>
                    </button>
                  ))}
                </div>
              ...
              {results!.comments.length > 0 && (
                <div>
                  ...
                  {results!.comments.map((comment) => (
                    ...
                    >
                      <div className="text-sm text-gray-700 dark:text-gray-300 line-clamp-1">{comment.content}</div>
          ...
          {!loading && !query.trim() && (
            <div className="text-center py-8">
              ...
              <p className="text-xs text-gray-300 dark:text-gray-600 mt-1">Search across tasks, boards, and comments</p>
            </div>
          )}
        </div>
      </div>
